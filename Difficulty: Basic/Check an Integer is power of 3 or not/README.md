<h2><a href="https://www.geeksforgeeks.org/problems/check-a-integer-is-power-of-3-or-not3850/1?page=7&difficulty=Basic&sortBy=submissions">Check an Integer is power of 3 or not</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a positive integer N, write a function to find if it is a power of three or not.</span></p>
