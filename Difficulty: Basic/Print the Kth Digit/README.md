<h2><a href="https://www.geeksforgeeks.org/problems/print-the-kth-digit3520/1?page=7&difficulty=Basic&sortBy=submissions">Print the Kth Digit</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given two numbers <strong>A</strong> and <strong>B</strong>, find K<sup>th</sup> digit from right of A<sup>B</sup>.</span><br>&nbsp;</p>
